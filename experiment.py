...
def example(stt_model: str, llm_model: str, tts_model: str, tts_voice: str) -> None:
    ...
    ros_agent = Agent(
        ...
        LlamaCPP(LLMParams(
            ...
            initial_prompt=ros_agent_prompt,
    ...
    chat_agent = Agent(
        ...
        LlamaCPP(LLMParams(
            model_path=llm_model,
            initial_prompt=chat_agent_prompt,
            n_of_tokens_to_predict=-1,  # gauge this reasonably
            n_of_gpu_layers_to_offload=43,
            server_hostname=socket.gethostbyname(socket.gethostname()),
            server_port=8083,
