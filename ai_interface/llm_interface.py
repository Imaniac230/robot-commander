...
class LLAMAInterface:
    ...
    def respond(self, prompt: str) -> str:
        ...
        '''
        ./build/bin/main -m /media/user/data_ssd/models/llama2/llama-2-13b-chat/ggml-model-q8_0.gguf -n 2048 -c 2048 -t 8 -tb 16 --color -r "User:" -f prompts/chat-with-bob.txt
        '''
        ...
        self.last_response = sp.check_output(self.library_path + self.bin_path + "main -m " + self.model_path + " --prompt \"" + prompt + "\"" + args, 
