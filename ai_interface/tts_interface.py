...
class BarkInterface:
    ...
    def synthesize_short(self, short_prompt: str):
        self.last_generation = generate_audio(short_prompt, history_prompt=self.speaker_voice, model_path=self.model_path)
    ...
    def synthesize(self, prompt: str):
        ...
        for section in processed_prompt:
            ...
            audio_array = semantic_to_waveform(
                generate_text_semantic(section, history_prompt=self.speaker_voice, temp=0.6, min_eos_p=0.05, model_path=self.model_path),
